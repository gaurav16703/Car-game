$(document).ready(function() {
    ...
    var prev_high_score = localStorage.getItem("highScore") || 0;
    high_score.text(prev_high_score);
    ...
    function repeat() {
        ...
        if (parseInt(score.text()) > parseInt(high_score.text())) {
    ...
    function stop_the_game() {
        ...
        var saved_high_score = parseInt(localStorage.getItem("highScore"));
